...
{ \
    { .Frequency = 470300000, .Rx1Frequency = 500300000, CN470_DEFAULT_DR_RANGE, .Band = 0 }, \
    { .Frequency = 470500000, .Rx1Frequency = 500500000, CN470_DEFAULT_DR_RANGE, .Band = 0 }, \
    { .Frequency = 470700000, .Rx1Frequency = 500700000, CN470_DEFAULT_DR_RANGE, .Band = 0 }, \
    { .Frequency = 470900000, .Rx1Frequency = 500900000, CN470_DEFAULT_DR_RANGE, .Band = 0 }, \
    { .Frequency = 471100000, .Rx1Frequency = 501100000, CN470_DEFAULT_DR_RANGE, .Band = 0 }, \
    { .Frequency = 471300000, .Rx1Frequency = 501300000, CN470_DEFAULT_DR_RANGE, .Band = 0 }, \
    { .Frequency = 471500000, .Rx1Frequency = 501500000, CN470_DEFAULT_DR_RANGE, .Band = 0 }, \
    { .Frequency = 471700000, .Rx1Frequency = 501700000, CN470_DEFAULT_DR_RANGE, .Band = 0 }, \
\
...
#define CN470_COMMON_JOIN_CHANNELS_SIZE             7

#define CN470_JOIN_CHANNELS                         { 0x00FF, 0x0000 }
